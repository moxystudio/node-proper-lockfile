...
function updateLock(file, options) {
    ...
    lock.updateTimeout = setTimeout(() => {
        ...
        options.fs.stat(getLockFile(file, options), (err, stat) => {
            ...
            const isMtimeOurs = module.exports.lock.mtimeChecker(lock.mtime, stat.mtime);
...
function createMtimeChecker() {
    ...
    return (lockMtime, statMtime) => {
        ...
        if (precision === 's') {
            return Math.trunc(lockMtime.getTime() / 1000) === Math.trunc(statMtime.getTime() / 1000);
        }
...
module.exports.lock.mtimeChecker = createMtimeChecker();
module.exports.createMtimeChecker = createMtimeChecker;
